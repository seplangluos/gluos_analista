...
// Dados da aplicação
const GLUOS_DATA = {
  usuarios: ["Pedro", "Rogério", "Isadora", "Andreza", "Hélica", "Juliana", "Frederico", "Gabriella", "Renata", "Ana Luiza", "Maysa", "Marcella", "Lúcia", "Fernanda", "Andre", "Admin"],
  assuntos: [
    ...
    {id: 16, texto: "Passo para Vistoria"},
  ]
};
